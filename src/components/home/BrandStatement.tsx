...
export const BrandStatement: React.FC = () => {
  return (
    <section className="py-20 sm:py-28 bg-espresso text-cream overflow-hidden relative">
      {/* Background Subtle Feminine Rose-Bronze Glow */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-blush-rose/15 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-bronze/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 relative">
            ...
            <div className="hidden sm:block absolute -bottom-6 -right-6 bg-cream-soft text-espresso p-6 shadow-2xl border border-blush-300/60 max-w-xs">
              <span className="text-[10px] uppercase tracking-ultra-wide text-bronze-rose font-medium block mb-1">
                Atelier Philosophy
              </span>
          ...
          <div className="lg:col-span-7 space-y-6 lg:pl-6">
            <span className="text-xs uppercase tracking-luxury text-bronze-rose font-medium block">
              The EVORA Philosophy
            </span>

            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif text-cream-light leading-[1.15] font-normal">
              Her Style. Her Presence. <span className="italic text-bronze-light">Her EVORA.</span>
            </h2>

            <div className="h-[1px] w-16 bg-gradient-to-r from-bronze-rose to-bronze-light/40 my-4" />
            ...
            <div className="space-y-4 text-sm sm:text-base font-light text-cream-muted leading-relaxed">
              ...
              <p className="font-serif italic text-lg sm:text-xl text-cream border-l-2 border-bronze-rose/60 pl-4 py-1">
            ...
            <div className="pt-4 flex items-center gap-6">
              <Link
                href="/about"
                className="inline-flex items-center gap-2 px-6 py-3.5 bg-cream text-espresso hover:bg-white text-xs uppercase tracking-luxury font-medium transition-colors shadow-feminine"
              >
